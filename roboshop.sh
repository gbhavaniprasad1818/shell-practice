...
ZONE_ID="Z07584103HNUBABVPVCNI" # replace with your zone ID
DOMAIN_NAME="fancyworld.shop" # replace with your domain name
R="\e[31m"
G="\e[32m"
Y="\e[33m"
N="\e[0m"
...
do
    ...
    if [ $ACTION == "create" ]; then
        if [ $INSTANCE_ID == "None" ]; then
            ...
            --security-groups "sg-roboshop-common" "sg-roboshop-$instance" \
